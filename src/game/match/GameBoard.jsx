    ...
    <div className={style.main}>
      <div className={style.layout}>
        <div className={style.hero}>
          <Image src="/game/layout/dashboard_stats.png" width={500} height={500} />
        </div>
        ...
        <div className={style.commitBtn} disabled={isCommited} onClick={handleCommit}>
          {isCommited
            ? <Image src="/game/layout/btn_commit_pressed.gif" width={200} height={100} />
            : (
              <>
                <Image src="/game/layout/btn_commit.png" width={200} height={100} />
